        ...
        <div class="p-4 user-profile-desc" data-simplebar="init">
            ...
            <div id="settingprofile" class="accordion">
                <div class="accordion-item card border mb-2">
                    ...
                    <div id="personalinfo" class="accordion-collapse collapse" aria-labelledby="personalinfo1" data-bs-parent="#settingprofile" style="">
                ...
                <div class="accordion-item card border mb-2 d-none">
                    ...
                    <div id="privacy" class="accordion-collapse collapse" aria-labelledby="privacy1" data-bs-parent="#settingprofile" style="">
                        <div class="accordion-body">
                            <div class="py-3">
                ...
                <div class="accordion-item card border mb-2 d-none">
                    ...
                    <div id="security" class="accordion-collapse collapse" aria-labelledby="security1" data-bs-parent="#settingprofile" style="">
                        <div class="accordion-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-1 overflow-hidden">
                ...
                <div class="accordion-item card border mb-2 d-none">
                    ...
                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="help1" data-bs-parent="#settingprofile" style="">
                        <div class="accordion-body">
                            <div class="py-3">
            ...
            <!-- end profile-setting-accordion -->
                ...
                <div class="simplebar-placeholder" style="width: auto; height: 250px;"></div>
            </div>
            <div class="simplebar-track simplebar-horizontal" style="visibility: hidden;">
                <div class="simplebar-scrollbar" style="transform: translate3d(0px, 0px, 0px); display: none;"></div>
            </div>
            <div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="transform: translate3d(0px, 0px, 0px); display: block; height: 163px;"></div></div></div>
